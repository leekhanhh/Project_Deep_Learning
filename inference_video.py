...
ap.add_argument("-c", "--conf", type=float, default=0.92,
...
#Save model attendance to csv
def MarkAttendance(name):
    with open('../recognition_final_project/attendance.csv','r+') as f:
